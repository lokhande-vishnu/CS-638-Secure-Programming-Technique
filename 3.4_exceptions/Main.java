...
public class Main {
	...
	private static boolean checkPW(String username, String password) {
		...
		try {
			...
			// ex.printStackTrace(System.err); // Removing the stack trace printing

		        // >> Removing both the stack trace and the input query
		        // The stack trace reveals the structure of the program which is bad
		        // The input query might reveal the invisible passwords entered by the user, bad again.
